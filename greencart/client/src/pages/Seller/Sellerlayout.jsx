    ...
    return (
        <div className="min-h-screen bg-gray-50/30">
            ...
            <div className="flex items-start">
                <div className="md:w-64 w-16 border-r min-h-[95vh] text-base border-gray-300 pt-4 flex flex-col bg-white">
                    {sidebarLinks.map((item) => (
                        ...
                        >
                            <img src={item.icon} alt={item.name} className="w-6 h-6 grayscale opacity-70 group-[.active]:grayscale-0" />
